...
function calculate() {
  ...
  if (cScore == 5 || uScore == 5) {
    ...
    if(cScore == 5){
        document.querySelector('.popup h3').innerHTML = `Computer has won the game by ${cScore} - ${uScore}!!!`
        document.querySelector(
            ".uScore"
        ...
        document.querySelector('.popup h3').innerHTML = `User has won the game by ${uScore} - ${cScore}!!!`
        document.querySelector(
            ".uScore"
          ).innerHTML = `<h3 class="cScore">User Scores : ${uScore = 0}</h3>`;
